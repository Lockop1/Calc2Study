...
| 4 | Content authoring (9 topics, parallel content-author agents) | ◐ | 9 authors launched in parallel (one per topic) |
| 5 | Content verification (math-verifier per file, blind-option test, VERIFICATION_LOG.md) | ☐ | |
| 6 | Flash Drill mode | ◐ | ui-builder agent running (Tasks 6–8 together) |
| 7 | Step-Through mode | ◐ | ui-builder |
| 8 | Topic picker, Review mode, progress, settings | ◐ | ui-builder |
