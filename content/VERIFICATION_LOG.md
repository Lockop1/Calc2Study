...
|-------|-----------------|-------------------|------------------|--------------------|------------|-------------|
| antiderivatives | content-author #ac92cab | math-verifier #a1d6959 | 79/79 pass | FAIL (13 FORM_LEAK; 0 wrong answers) | 43/121 units sampled (36%); 42 hits (chance 8.2), 3 surface-guessable | 13 flagged units rewritten, 8 non-blocking retags applied; 82/82 pass |
