...
export const flash: FlashItem[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { latex: '\\cos^2 x = 1 + \\cos x', expr: '1 + cos(x)', mistake: 'half-angle-wrong', why: 'Two slips: the factor 1/2 is missing and the angle was not doubled (cos 2x, not cos x).' },
      { latex: '\\cos^2 x = \\frac{1 + \\sin 2x}{2}', expr: '(1 + sin(2*x))/2', mistake: 'half-angle-wrong', why: 'cos 2x, not sin 2x, appears in the power-reducing identities.' },
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
      ...
      { latex: '\\sin x\\cos x = 2\\cos 2x', expr: '2*cos(2*x)', mistake: 'double-angle-wrong', why: 'Two slips: the product sin x cos x comes from sin 2x (not cos 2x), and the 2 went to the wrong side of sin 2x = 2 sin x cos x.' },
  ...
  },
  {
    ...
    options: [
      ...
      { latex: '\\frac{1 - \\cos 6x}{6}', expr: '(1 - cos(6*x))/6', mistake: 'coefficient-mishandled', why: 'The inner 3 only changes the angle here; a 1/k factor appears when you integrate, not in the identity.' },
  ...
  },
  {
    ...
    options: [
      ...
      { latex: '\\frac{1 - \\cos 2t}{2}', expr: '(1 - cos(2*t))/2', mistake: 'half-angle-wrong', why: 'Two slips: the angle t/2 was doubled twice (to 2t), and the minus sign belongs to sin², not cos².' },
    ],
    correct: 2,
  ...
  // ───────────── antiderivatives: sine / cosine ─────────────
  {
    ...
    options: [
      ...
      { latex: '\\sin x + \\sin^3 x + C', expr: 'sin(x) + sin(x)^3', mistake: 'pythagorean-wrong', why: 'Two slips: cos²x = 1 − sin²x (not 1 + sin²x), and ∫u² du = u³/3 lost its 1/3.' },
  ...
  },
  {
    ...
    options: [
      ...
      { latex: '-\\frac{1}{3}\\sin^3 x - \\frac{1}{5}\\sin^5 x + C', expr: '-sin(x)^3/3 - sin(x)^5/5', mistake: 'back-substitution-wrong', why: 'Two slips: u = cos x was replaced by sin x, and sin²x was taken as 1 + cos²x, which makes the u⁵ term negative.' },
  ...
  },
  {
    ...
    options: [
      ...
      { latex: '-\\frac{1}{6}\\cos^6 x + C', expr: '-cos(x)^6/6', mistake: 'reciprocal-identity-confused', why: 'sec⁵x = 1/cos⁵x, not cos⁵x; this integrates sin x cos⁵x instead.' },
    ],
    correct: 3,
  ...
  },
  {
    ...
    options: [
      ...
      { latex: '-\\frac{1}{3}\\sin^3\\frac{t}{2} + \\frac{1}{5}\\sin^5\\frac{t}{2} + C', expr: '-sin(t/2)^3/3 + sin(t/2)^5/5', mistake: 'inner-constant-factor-missing', why: 'Two slips: cos(t/2)dt = 2du lost its factor 2, and a minus sign was attached to du as if u were cos(t/2).' },
  ...
  },
  {
    ...
    options: [
      ...
      { latex: '-\\frac{1}{4}\\sin^2 x\\cos 2x + C', expr: '-sin(x)^2*cos(2*x)/4', mistake: 'product-rule-integral', why: 'Two slips: sin²x was treated as a constant while integrating sin 2x, and ∫sin 2x dx was taken as −¼cos 2x instead of −½cos 2x.' },
  ...
  },
  {
    ...
    options: [
      ...
      { latex: '-\\frac{2}{3}\\sin^3\\frac{x}{2} + C', expr: '-2*sin(x/2)^3/3', mistake: 'back-substitution-wrong', why: 'Two slips: sin x = 2 sin(x/2)cos(x/2) lost its 2, and u = cos(x/2) was replaced by sin(x/2) when substituting back.' },
    ],
    correct: 3,
  ...
  },
  {
    ...
    options: [
      ...
      { latex: '0', expr: '0', mistake: 'u-choice-wrong', why: 'cos⁴(2t) was integrated as cos⁵(2t)/10 by the power rule, although du = −2 sin 2t dt is not present; that function is equal at 0 and π.' },
      { latex: '\\frac{3\\pi}{16}', expr: '3*pi/16', mistake: 'coefficient-mishandled', why: 'The constant term 3/8 was divided by the inner 2; a 1/k factor applies only when integrating cos(kt).' },
    ],
    correct: 3,
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Save one $\\cos 3x$ and let $u = \\sin 3x$, so $du = \\cos 3x\\,dx$', mistake: 'du-constant-wrong', why: 'd/dx sin 3x = 3cos 3x, so du = 3cos 3x dx; the inner 3 must be accounted for.' },
  ...
  },
  {
    ...
    options: [
      { text: 'Write $\\sin^4 x = \\frac{1 - \\cos 4x}{2}$ and integrate', mistake: 'half-angle-wrong', why: 'Two slips: the half-angle identity reduces sin²x, not sin⁴x, and it doubles the angle to 2x, not 4x.' },
  ...
  // ───────────── concept: what the substitution produces ─────────────
  {
    ...
    options: [
      ...
      { latex: '\\int u^2(u^2 - 1)^2\\,du', expr: 'indefinite(u^2*(u^2 - 1)^2, u)', mistake: 'exponent-arithmetic', why: 'After saving sec x tan x only tan²x = u² − 1 remains; squaring it describes tan⁵x.' },
  ...
  },
  {
    ...
    options: [
      ...
      { latex: '\\int u^2(1 + u^2)\\,du', expr: 'indefinite(u^2*(1 + u^2), u)', mistake: 'trig-wrong-factor-saved', why: 'Two slips: a sin x was removed as if it had been saved (sin³x stays u³), and cos²x was written as 1 + u².' },
    ],
    correct: 1,
  ...
  },
  {
    ...
    options: [
      { latex: '-du', expr: '-du', mistake: 'du-constant-wrong', why: 'du = −2 sin 2x dx; the inner 2 must be divided out, giving −½du.' },
      { latex: '\\frac{1}{2}\\,du', expr: 'du/2', mistake: 'u-cos-sign-missing', why: 'd(cos 2x) = −2 sin 2x dx; the minus sign was dropped.' },
      { latex: '-2\\,du', expr: '-2*du', mistake: 'du-constant-wrong', why: 'Multiplied by the inner 2 instead of dividing by it.' },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Neither is right: the only correct form is $-\\frac{1}{4}\\cos 2x + C$ from the double-angle identity', mistake: 'antiderivative-not-unique', why: '−¼cos 2x + C is a third member of the same family; antiderivatives are unique only up to a constant.' },
      { text: 'They cannot agree, since $\\frac{1}{2}\\sin^2 x$ and $-\\frac{1}{2}\\cos^2 x$ are different functions', mistake: 'antiderivative-not-unique', why: 'Two antiderivatives may differ by a constant; here the difference is exactly 1/2.' },
    ],
    correct: 2,
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Write $\\tan^2 x = \\sec^2 x + 1$; $\\int \\sec^3 x\\,dx$ reappears and cancels from both sides', mistake: 'tan-sec-identity-direction', why: 'Two slips: tan²x = sec²x − 1 (not + 1), and the reappearing integral does not cancel; moving it to the left gives 2∫sec³x dx.' },
    ],
    correct: 1,
